...
print("El numero ingresado tiene", len(num), "digitos")
...
suma=0
while True: 
    num=int(input("Por favor ingese un numero entero (Ingresar cero para finalizar el programa):"))
    if num==0:
        break
    suma+=num
...
intentos=0
while True:
    num_usuario=int(input("Adivine el numero aleatorio entre 0 y 9:"))
    intentos+=1
